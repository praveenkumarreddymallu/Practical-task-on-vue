        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <div class="login-panel bg-white text-left">
                    <p class="display-5 font-weight-bold">Welcome to RDPL</p>
                    ...
                    <h5 class="display-4 font-weight-bold">Login</h5>
                    
                    <br>
                    <form action="">
                        <div class="form-group">
                            <lable class="input-label">Email or Username</lable>
                            <input type="email" class="form-control" placeholder="Please enter email or username">
                        </div>
